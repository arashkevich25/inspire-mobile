...
interface FormBasicMemberContactProps extends FormikProps<UserContactData> {
    updateIsPending: boolean;
    userDetails: UserContactData;
}

function Component(formikProps: FormBasicMemberContactProps, ref: any) {
...
export const FormBasicMemberContact = forwardRef(Component);
